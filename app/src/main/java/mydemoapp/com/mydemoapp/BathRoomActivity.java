...
public class BathRoomActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bathroomlayout);

        this.arraySpinner = new String[] {
                "Select","Light 1", "Tap", "Shower"
        };
        Spinner s = (Spinner) findViewById(R.id.spinnerbath);
        next = (Button)findViewById(R.id.buttonbath);
