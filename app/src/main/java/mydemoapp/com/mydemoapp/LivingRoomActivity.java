...
public class LivingRoomActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.livingroomlayout);

        this.arraySpinner = new String[] {
                "Select","Light 1", "Light 2", "Others"
        };
        Spinner s = (Spinner) findViewById(R.id.spinnerliving);
        next = (Button)findViewById(R.id.buttonliving);
